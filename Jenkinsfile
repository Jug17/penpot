        ...
        stage('Checkout Source Code') {
            steps {
                ...
                sh '''
                    ...
                    test -f "$COMPOSE_FILE" || {
                        echo "ERROR: $COMPOSE_FILE is missing from the repository."
                        echo "Store the pipeline deployment files in the same repository as this Jenkinsfile."
                        exit 1
                    }
                    ...
                    if (findingCount > 0) {
                        ...
                        writeFile(
                            ...
                            text: [
                                ...
                                "Recipient: ${params.DEVELOPER_EMAIL}",
                        ...
                        echo "Security notification emailed to ${params.DEVELOPER_EMAIL}."
                    } else {
                        writeFile(
                            file: 'reports/notification/email-notification.txt',
    ...
    post {
        ...
        failure {
            script {
                ...
                echo "Pipeline failure notification emailed to ${params.DEVELOPER_EMAIL}."
            }
        }
